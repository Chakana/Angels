<div class="vendedores view">
	...
	<div class="row">
		...
		<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete Vendedore'), array('action' => 'delete', $vendedore['Vendedore']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $vendedore['Vendedore']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Vendedores'), array('action' => 'index'), array('escape' => false)); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Vendedore'), array('action' => 'add'), array('escape' => false)); ?> </li>

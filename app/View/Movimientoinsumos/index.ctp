<div class="movimientoinsumos index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Movimientoinsumos'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Movimientoinsumo'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
				<?php foreach ($movimientoinsumos as $movimientoinsumo): ?>
					<tr>
						<td><?php echo h($movimientoinsumo['Movimientoinsumo']['id']); ?>&nbsp;</td>
								<td>
			...
			<?php echo $this->Html->link($movimientoinsumo['EncargadosAlmacene']['id'], array('controller' => 'encargados_almacenes', 'action' => 'view', $movimientoinsumo['EncargadosAlmacene']['id'])); ?>
						...
						<td><?php echo h($movimientoinsumo['Movimientoinsumo']['cantidad']); ?>&nbsp;</td>
						<td><?php echo h($movimientoinsumo['Movimientoinsumo']['tipoMovimiento']); ?>&nbsp;</td>
						<td><?php echo h($movimientoinsumo['Movimientoinsumo']['fechaMovimiento']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $movimientoinsumo['Movimientoinsumo']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $movimientoinsumo['Movimientoinsumo']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $movimientoinsumo['Movimientoinsumo']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $movimientoinsumo['Movimientoinsumo']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>

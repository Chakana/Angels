	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Ventadetalles'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;New Ventadetalle'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				<thead>
					<tr>
						...
						<th><?php echo $this->Paginator->sort('precioTotal'); ?></th>
						<th class="actions"></th>
					</tr>
				</thead>
				<tbody>
			...
			<?php echo $this->Html->link($ventadetalle['Producto']['id'], array('controller' => 'productos', 'action' => 'view', $ventadetalle['Producto']['id'])); ?>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $ventadetalle['Ventadetalle']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $ventadetalle['Ventadetalle']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>

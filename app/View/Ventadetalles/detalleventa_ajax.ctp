				...
				<div class="row">
					...
					<table cellpadding="0" cellspacing="0" class="table table-striped" >
						...
						<tr>
								...
								<td></td>
								<td>TOTAL VENTA</td>
								<td><div id = "sumaVentaTotal"><?php echo $this->Number->currency($sumaVentaTotal,'BS');?></div></td>
						</tr>
						<tr>
								<td></td>
								<td></td>
								...
								<td>Pagado</td>
								<td>
									<div id="sumaPagos"><?php echo $this->Number->currency($sumaPagos,'BS');?></div>
								</td>
						</tr>
						<tr>
								<td></td>
								...
								<td>Saldo</td>
								<td>
									<div id="total"><?php echo $this->Number->currency($saldo,'BS');?></div>
								</td>
						</tr>
						</tbody>
					</table>
